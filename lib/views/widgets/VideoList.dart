...
class _VideoListState extends State<VideoList> {
  ...
  Future<List<Map<String, dynamic>>> getVideosByUid(String uid) async {
    ...
    try {
      ...
      videos = querySnapshot.docs.map((doc) => doc.data()).cast<Map<String, dynamic>>().toList();
    } catch (e) {
  ...
  void fetchVideos() async {
    ...
    setState(() {
      videoUrls = videos.map((video) => video['videoUrl']).cast<String>().toList();
    });
  }
          ...
          Expanded(
            child: GestureDetector(
              onTap: () {
                ...
                print('Clic sur la vidéo: $videoUrl');
              },
              child: Container(
                height: 160,
